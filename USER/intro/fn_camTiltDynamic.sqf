params ["_camera", "_newObject", "_duration", ["_strength", 2]];
...
}, 0, [_oldVectorDir, _oldVectorUp, _newObject, _initTime, _duration, _camera, _strength]] call CBA_fnc_addPerFrameHandler;